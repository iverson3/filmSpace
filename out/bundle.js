...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Body = __webpack_require__(227);
	...
	_reactDom2.default.render(_react2.default.createElement(
	    ...
	    _react2.default.createElement(
	        ...
	        _react2.default.createElement(IndexRoute, { component: _Body2.default }),
	        _react2.default.createElement(_reactRouter.Route, { path: '/film/:statusName', component: _Body2.default })
	    )
	    ...
	    _createClass(App, [{
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                'div',
	                { className: 'app' },
	                _react2.default.createElement(_Header2.default, { cutMenu: this.cutMenu.bind(this) }),
	                _react2.default.createElement(_Menu2.default, { classNameProp: classNameProp }),
	                this.props.children
	            );
	        }
	    }]);
	    ...
	    _createClass(Header, [{
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    "div",
	                    { className: "header-menuicon", onClick: this.cutMenu.bind(this) },
	                    "Menu"
	                ),
	                _react2.default.createElement(
	                    "div",
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _MenuLink = __webpack_require__(226);
	...
	var Menu = function (_React$Component) {
	    ...
	    _createClass(Menu, [{
	        ...
	        value: function render() {
	            var that = this;
	            // 模拟数据
	            var title = "webpack test";
	            var jsonStr = '[{"id": 1, "title": "aaaaaaaa", "url": "/film/online"}, {"id": 2, "title": "bbbbbbbb", "url": "/film/coming"}]';
	            var data = JSON.parse(jsonStr);

	            var menus = data.map(function (res, index) {
	                // 判断当前被点击的子组件
	                // if (that.state.selectedItem === res.id) {
	                //
	                // } else {
	                //
	                // }
	                return _react2.default.createElement(
	                    "li",
	                    { className: "menu-item", key: index, no: res.id },
	                    _react2.default.createElement(
	                        "p",
	                        { className: "menu-item-p" },
	                        _react2.default.createElement(
	                            _MenuLink2.default,
	                            { to: res.url },
	                            res.title
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MenuLink = function (_React$Component) {
	    ...
	    _createClass(MenuLink, [{
	        key: 'render',
	        value: function render() {
	            return _react2.default.createElement(_reactRouter.Link, _extends({}, this.props, { className: 'menu-link', activeClassName: 'menu-active' }));
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Online = __webpack_require__(228);

	var _Online2 = _interopRequireDefault(_Online);

	var _Coming = __webpack_require__(229);
	...
	var Body = function (_React$Component) {
	    ...
	    _createClass(Body, [{
	        ...
	        value: function render() {
	            var main = null;
	            if (_typeof(this.props.params.statusName) === undefined) {
	                // 首页
	                main = _react2.default.createElement(_Index2.default, null);
	            } else {
	                if (this.props.params.statusName == 'online') {
	                    main = _react2.default.createElement(_Online2.default, null);
	                } else {
	                    main = _react2.default.createElement(_Coming2.default, null);
	                }
	            }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Online = function (_React$Component) {
	    ...
	    function Online() {
	        ...
	        return _possibleConstructorReturn(this, Object.getPrototypeOf(Online).apply(this, arguments));
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Coming = function (_React$Component) {
	    ...
	    function Coming() {
	        ...
	        return _possibleConstructorReturn(this, Object.getPrototypeOf(Coming).apply(this, arguments));
	    }
